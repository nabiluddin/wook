  ...
  return (
    <motion.div
      ...
      <div className="fair-img">
        <iframe className='iframe' src="https://www.pinksale.finance/launchpad/0x314857fa43243360440580Becb85686fAa606500?chain=ETH" frameborder="0" scrolling="yes"></iframe>
        ...
        <iframe className='iframe if-f2' src="https://www.youtube.com/embed/5psWCwekmA0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
